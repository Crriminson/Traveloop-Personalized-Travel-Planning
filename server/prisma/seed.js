...
const cities = [
  { name:'Paris',country:'France',region:'Île-de-France',latitude:48.8566,longitude:2.3522,costIndex:3,popularityScore:98,description:'The City of Light, famous for art, fashion, and cuisine.',imageUrl:'https://images.unsplash.com/photo-1502602898660-5a24226f5d13?w=800&q=80',timezone:'Europe/Paris' },
  { name:'Rome',country:'Italy',region:'Lazio',latitude:41.9028,longitude:12.4964,costIndex:2,popularityScore:95,description:'Eternal city packed with ancient history and world-class food.',imageUrl:'https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=800&q=80',timezone:'Europe/Rome' },
  { name:'Barcelona',country:'Spain',region:'Catalonia',latitude:41.3851,longitude:2.1734,costIndex:2,popularityScore:93,description:'Vibrant coastal city famed for Gaudí and its nightlife.',imageUrl:'https://images.unsplash.com/photo-1583422409516-dc8f120bf663?w=800&q=80',timezone:'Europe/Madrid' },
  ...
  { name:'New York',country:'USA',region:'New York',latitude:40.7128,longitude:-74.0060,costIndex:3,popularityScore:97,description:'The city that never sleeps — iconic skyline, culture, and energy.',imageUrl:'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=800&q=80',timezone:'America/New_York' },
  ...
  { name:'Amsterdam',country:'Netherlands',region:'North Holland',latitude:52.3676,longitude:4.9041,costIndex:2,popularityScore:89,description:'Charming canal city known for cycling, art, and open culture.',imageUrl:'https://images.unsplash.com/photo-1512470876302-972faa2aa9a4?w=800&q=80',timezone:'Europe/Amsterdam' },
  { name:'Prague',country:'Czech Republic',region:'Bohemia',latitude:50.0755,longitude:14.4378,costIndex:1,popularityScore:88,description:'Fairy-tale architecture and a thriving craft beer scene.',imageUrl:'https://images.unsplash.com/photo-1519677100203-a0e8783190e3?w=800&q=80',timezone:'Europe/Prague' },
  ...
  { name:'Istanbul',country:'Turkey',region:'Marmara',latitude:41.0082,longitude:28.9784,costIndex:1,popularityScore:90,description:'Where East meets West — mosques, bazaars, and Bosphorus views.',imageUrl:'https://images.unsplash.com/photo-1522231999020-3a9d6c38260a?w=800&q=80',timezone:'Europe/Istanbul' },
  { name:'Lisbon',country:'Portugal',region:'Lisbon',latitude:38.7223,longitude:-9.1393,costIndex:2,popularityScore:87,description:'Hilly city of fado music, trams, and pastel de nata.',imageUrl:'https://images.unsplash.com/photo-1580954316047-920b72a0f5fc?w=800&q=80',timezone:'Europe/Lisbon' },
  { name:'Vienna',country:'Austria',region:'Vienna',latitude:48.2082,longitude:16.3738,costIndex:2,popularityScore:86,description:'Imperial grandeur, classical music, and world-renowned coffee houses.',imageUrl:'https://images.unsplash.com/photo-1516550893868-b7ab47ea2008?w=800&q=80',timezone:'Europe/Vienna' },
  ...
  { name:'Sydney',country:'Australia',region:'New South Wales',latitude:-33.8688,longitude:151.2093,costIndex:3,popularityScore:90,description:'Iconic harbour city with golden beaches and a laid-back lifestyle.',imageUrl:'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=800&q=80',timezone:'Australia/Sydney' },
  { name:'Cape Town',country:'South Africa',region:'Western Cape',latitude:-33.9249,longitude:18.4241,costIndex:1,popularityScore:85,description:'Stunning coastal city at the foot of Table Mountain.',imageUrl:'https://images.unsplash.com/photo-1580060839134-75a5edca2e99?w=800&q=80',timezone:'Africa/Johannesburg' },
  { name:'Marrakech',country:'Morocco',region:'Marrakech-Safi',latitude:31.6295,longitude:-7.9811,costIndex:1,popularityScore:84,description:'Medieval medina city with souks, riads, and exotic spices.',imageUrl:'https://images.unsplash.com/photo-1539020140153-e479b8c22e70?w=800&q=80',timezone:'Africa/Casablanca' },
  { name:'Buenos Aires',country:'Argentina',region:'Buenos Aires',latitude:-34.6037,longitude:-58.3816,costIndex:1,popularityScore:83,description:'The Paris of South America — tango, steak, and European flair.',imageUrl:'https://images.unsplash.com/photo-1611003444053-9031c5b8df47?w=800&q=80',timezone:'America/Argentina/Buenos_Aires' },
  { name:'Mexico City',country:'Mexico',region:'Valley of Mexico',latitude:19.4326,longitude:-99.1332,costIndex:1,popularityScore:82,description:'Massive megalopolis with world-class museums and incredible tacos.',imageUrl:'https://images.unsplash.com/photo-1518105779142-d971f22144d1?w=800&q=80',timezone:'America/Mexico_City' },
  { name:'Kyoto',country:'Japan',region:'Kansai',latitude:35.0116,longitude:135.7681,costIndex:2,popularityScore:94,description:'Ancient capital with thousands of temples, shrines, and bamboo groves.',imageUrl:'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800&q=80',timezone:'Asia/Tokyo' },
  { name:'Berlin',country:'Germany',region:'Berlin',latitude:52.5200,longitude:13.4050,costIndex:2,popularityScore:88,description:'Edgy creative capital with a turbulent history and thriving arts scene.',imageUrl:'https://images.unsplash.com/photo-1560930950556-46ea0bc593f0?w=800&q=80',timezone:'Europe/Berlin' },
  { name:'Budapest',country:'Hungary',region:'Central Hungary',latitude:47.4979,longitude:19.0402,costIndex:1,popularityScore:87,description:'Two cities united by the Danube — thermal baths and ruin bars.',imageUrl:'https://images.unsplash.com/photo-1515093618146-5db2b29cba53?w=800&q=80',timezone:'Europe/Budapest' },
  { name:'Reykjavik',country:'Iceland',region:'Capital Region',latitude:64.1355,longitude:-21.8954,costIndex:3,popularityScore:80,description:'Gateway to the Northern Lights, geysers, and midnight sun.',imageUrl:'https://images.unsplash.com/photo-1518414844391-766b6c0bc1cc?w=800&q=80',timezone:'Atlantic/Reykjavik' },
  { name:'Havana',country:'Cuba',region:'La Habana',latitude:23.1136,longitude:-82.3666,costIndex:1,popularityScore:78,description:'Colourful vintage cars, salsa rhythms, and crumbling Baroque grandeur.',imageUrl:'https://images.unsplash.com/photo-1503940176412-fb68b64b1827?w=800&q=80',timezone:'America/Havana' },
  { name:'Kathmandu',country:'Nepal',region:'Bagmati',latitude:27.7172,longitude:85.3240,costIndex:1,popularityScore:76,description:'Himalayan gateway city with ancient durbar squares and trekking culture.',imageUrl:'https://images.unsplash.com/photo-1540306179374-9d10e0573e35?w=800&q=80',timezone:'Asia/Kathmandu' },
  { name:'Cairo',country:'Egypt',region:'Cairo',latitude:30.0444,longitude:31.2357,costIndex:1,popularityScore:85,description:'Millennial city beside the Nile, home to the Great Pyramids.',imageUrl:'https://images.unsplash.com/photo-1553603227-2366aaca8e5e?w=800&q=80',timezone:'Africa/Cairo' },
  { name:'Petra',country:'Jordan',region:'Aqaba',latitude:30.3285,longitude:35.4444,costIndex:2,popularityScore:79,description:'Rose-red city half as old as time carved into desert cliffs.',imageUrl:'https://images.unsplash.com/photo-1503114949540-db6354b4f0b2?w=800&q=80',timezone:'Asia/Amman' },
  { name:'Vancouver',country:'Canada',region:'British Columbia',latitude:49.2827,longitude:-123.1207,costIndex:3,popularityScore:86,description:'Mountain-meets-ocean city with world-class ski and surf.',imageUrl:'https://images.unsplash.com/photo-1559825481-12a05cc00344?w=800&q=80',timezone:'America/Vancouver' },
  { name:'Santorini',country:'Greece',region:'South Aegean',latitude:36.3932,longitude:25.4615,costIndex:3,popularityScore:92,description:'Iconic caldera island with white-domed churches and volcanic beaches.',imageUrl:'https://images.unsplash.com/photo-1570077151733-149eb050b16d?w=800&q=80',timezone:'Europe/Athens' },
];
